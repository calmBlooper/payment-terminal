...
void DBManager::fillUpTheTables() {
	PrivateAccount pa1(111, "UAH", 100.0, "Біба", "Боба");
	PrivateAccount pa2(222, "UAH", 999000.0, "Микола", "Шевчук");
	PrivateAccount pa3(333, "UAH", 1000.0, "Alex", "Sad");
	PrivateAccount pa4(444, "UAH", 100000.0, "Андрій", "Степаненко");
	privateRep.insert(pa1);
	privateRep.insert(pa2);
	privateRep.insert(pa3);
	privateRep.insert(pa4);

	PublicAccount pubAcc1("UAH", 100.0, "Чоклинський Артем Вікторович", "вулиця Марини Цвєтаєвої, 14Б");
	publicRep.insert(pubAcc1);

	PublicAccount pubAcc2("UAH", 5360.64, "Михайлишин Павло Васильович", "вулиця Харківське шосе, 168є, кв. 325");
	publicRep.insert(pubAcc2);

	PublicAccount pubAcc3("UAH", 55.74, "Гігантюк Кіндрат Каленикович", "вулиця Зарічна, 1А, кв. 14");
	publicRep.insert(pubAcc3);

	PublicAccount pubAcc4("UAH", 4643664.6, "Українська Біржа Благодійності", "вулиця Марини Цвєтаєвої, 1А");
	publicRep.insert(pubAcc4);

	PublicAccount pubAcc5("UAH", 46446464.6, "Червоний хрест", "вулиця Хрещатик, 13");
	publicRep.insert(pubAcc5);

	PublicAccount pubAcc6("UAH", 4646464.7, "Всесвітній Центр Свідків Єгови", "вулиця Зарічна, 777");
